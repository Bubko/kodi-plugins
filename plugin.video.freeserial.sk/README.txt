# Kodi video plugin to freefilm.sk

Kodi Plugin that lets you watch almost all movies HD and for free from topserialy.to.

# Prerequisites
- Kodi Version 17.0+
- [PhantomJS](http://phantomjs.org/) - Scriptable Headless WebKit need to be in **executable path!**
